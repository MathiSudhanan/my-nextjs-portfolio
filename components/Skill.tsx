  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-gray-500 object-cover h-24 w-24 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
      <div
        ...
        className="absolute opacity-0 group-hover:opacity-80 group-hover:bg-white h-24 w-24  rounded-full transition duration-300 ease-in-out"
      >
